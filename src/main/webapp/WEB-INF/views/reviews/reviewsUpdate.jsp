			...
			<table class="table" style="margin:0 auto;width:80%">
				...
				<tr>
					...
					<td>
						<div class="row">
							<div class="col-sm-2">
								<img style="width:100%" src="${ctp}/data/ckeditor/product/${vo.productfSName}">
							</div>
							<div class="col">
				...
				<tr>
					<th width="10%">제목</th>
					<td><input type="text" name="title" id="title" value="${vo.title}" class="form-control"></td>
				</tr>
				<tr>
					<td colspan="2">
						<textarea rows="15" name="content"  id="content" class="form-control" required>${vo.content}</textarea></td>
				</tr>
				<tr>
					<th>사진 파일</th>
					<td>
						<input type="file" name="file" value="${vo.FName}" id="file" class="form-control-file" multiple="multiple" accept=".jpg,.gif,.png,.jfif"/>
					</td>
				</tr>
				<tr>
