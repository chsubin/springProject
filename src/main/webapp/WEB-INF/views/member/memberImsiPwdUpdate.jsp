  ...
  <style>
	...
	<script>
		...
		function fCheck(){
			...
			if(newPwd.trim()==""||pwdConfirm.trim()==""){
				alert("빈칸을 모두 채워주세요.");
				return;
			}
...
<div class="container-fluid text-center" style="width:80%" >
	<form name="myform" method="post" action="${ctp}/member/memberImsiPwdUpdates">
			...
			<table class="table table-borderless" style="width:80%;margin:0 auto">
				...
				<tr class="text center">
					...
					<table class=" border"  style="width:100%;margin:0 auto">
						...
						<tr>
							<td colspan="2" class="pl-5 pr-5  pb-5"><input type="button" value="수정하기" onclick="fCheck()" class="form-control btn btn-lg" style="background-color:darkblue;color:white"></td>
						</tr>
					</table>
					</td>
				</tr>
		...
		<input type="hidden" name="mid" value="${sImsiMid}"/>
	</form>
</div>
