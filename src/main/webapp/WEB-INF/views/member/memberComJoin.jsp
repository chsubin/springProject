...
<script>
    ...
    else if(!myform.applyFlag.checked){
	...
	<form name="myform" method="post">
		<table class="table table-borderless form-group" >
			...
			<tr>
				...
				<td><input type="text" name="name" id="name" onkeyup="spaceCheck(this)" class="form-control bg-light"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="password" name="pwdConfirm" onkeyup="spaceCheck(this)" id="pwdConfirm" onkeyup="spaceCheck(this)" class="form-control bg-light"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="roadAddress" id="sample6_address" size="50"  class="form-control bg-light"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="postcode" id="sample6_postcode" class="form-control bg-light"></td>
			</tr>
			<tr>
				<td class="pl-2">연락처<font color="red">*</font></td>
				<td><input type="text" id="tel" name="tel" class="form-control bg-light"></td>
			</tr>
			<tr>
				<td class="pl-2">이메일 주소<font color="red">*</font></td>
				<td>
					<input type="text" name="email1" id="email1" class="form-control bg-light" onkeyup="spaceCheck(this)" style="width:33%;display:inline"> 
					@<input type="text" name="email2" id="email2" class="form-control bg-light" onkeyup="spaceCheck(this)"  style="width:32%;display:inline">
			...
			<tr>
				<td class="pl-2">법인명<font color="red">*</font></td>
				<td><input type="text" name="comname" id="comname" class="form-control bg-light"></td>
			</tr>
			<tr>
				<td class="pl-2">사업자등록번호<font color="red">*</font></td>
				<td><input type="text" name="comnumber" id="comnumber" class="form-control bg-light"></td>
			</tr>
			<tr>
				<td class="pl-2">대표자<font color="red">*</font></td>
				<td><input type="text" name="owner" id="owner" class="form-control bg-light"></td>
			</tr>
			<tr>
				<td class="pl-2">사업종류<font color="red">*</font></td>
				<td><input type="text" name="compart" id="compart" class="form-control bg-light"></td>
			</tr>
			<tr>
