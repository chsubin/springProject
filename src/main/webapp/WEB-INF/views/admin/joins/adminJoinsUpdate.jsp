			...
			<form name="myform" method="post" enctype="multipart/form-data">
				<table class="table" >
					...
					<tr>
						...
						<td><textarea rows="3" class="form-control" name="memo" >${vo.memo}</textarea></td>
					</tr>
					<tr>
						...
						<td>
							<table class="table">
								...
								<tr>
									<th>위도</th>
									<td><input type="text" name="latitude" class="form-control" value="" id="lat"/></td>
									<th>경도</th>
									<td><input type="text" name="longitude" class="form-control" value="" id="lng"/></td>
								</tr>
							</table>
							<hr/>
