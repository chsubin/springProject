  ...
  <div class="panel-group text-center table-hover" id="accordion">
    <div class="panel panel-default bg-light ">
      ...
      <div id="collapse1" class="panel-collapse collapse">
        ...
        <div class="panel-body pt-2 pb-2"><a href="${ctp}/admin/servey/adminServeyInput" target="adminContent">설문조사 등록</a></div>
        <div class="panel-body pt-2 pb-2"><a href="${ctp}/admin/servey/adminServeyList" target="adminContent">설문조사 관리</a></div>
      </div>
    </div>
    <div class="panel panel-default bg-light">
      <div class="panel-heading text-white">
      ...
      <div id="collapse2" class="panel-collapse collapse">
        ...
        <div class="panel-body pt-2 pb-2"><a href="${ctp}/admin/product/adminInputProduct" target="adminContent">상품 등록</a></div>
        <div class="panel-body pt-2 pb-2"><a href="${ctp}/admin/product/adminProductList" target="adminContent">상품 목록</a></div>
      </div>
    </div>
    <div class="panel panel-default bg-light">
      <div class="panel-heading text-white">
        <div class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse3">주문관리</a>
        </div>
      </div>
      <div id="collapse3" class="panel-collapse collapse">
        ...
        <div class="panel-body pt-2 pb-2"><a href="${ctp}/admin/extra/adminAnalize" target="adminContent">주문 통계</a></div>
      </div>
    </div>
    <div class="panel panel-default bg-light">
      <div class="panel-heading text-white">
        <div class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse4">제휴농가 관리</a>
        </div>
      </div>
      <div id="collapse4" class="panel-collapse collapse">
        ...
        <div class="panel-body pt-2 pb-2"><a href="${ctp}/admin/joins/adminJoinsList" target="adminContent">제휴농가 목록</a></div>
        <div class="panel-body pt-2 pb-2"><a href="${ctp}/admin/joins/adminJoinsRequest" target="adminContent">배송 요청</a></div>
    ...
    <div class="panel panel-default bg-light">
      <div class="panel-heading text-white ">
        <div class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse5">기타관리</a>
        </div>
      </div>
      <div id="collapse5" class="panel-collapse collapse">
        <div class="panel-body pt-2 pb-2"><a href="${ctp}/admin/extra/adminBasisUpdate" target="adminContent">배송정보 관리</a></div>

        <div class="panel-body pt-2 pb-2"><a href="${ctp}/admin/member/adminMemberList" target="adminContent">회원 목록</a></div>
        <div class="panel-body pt-2 pb-2"><a href="${ctp}/admin/member/adminMemberAnalize" target="adminContent">회원 통계</a></div>
