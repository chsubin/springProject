...
<div class="container-fluid p-3">
	<div class="container-fluid p-5 mb-3 border shadow-sm" style="background-color:#fff">
		<table class="table table-borderless">
			...
			<tr>
				<td>기간설정</td>
				<td>시작일시 <input type="date" name="startDate" class="form-control" style="display:inline;width:33%"/> - 마감일시 <input type="date" name="endDate" class="form-control" style="display:inline;width:33%"/><input type="submit" class="btn btn-outline-success" value="생성" style="display:inline;width:18%"/></td> 
			</tr>
			<tr>
				<td>설문항목 관리</td>
				<td>
