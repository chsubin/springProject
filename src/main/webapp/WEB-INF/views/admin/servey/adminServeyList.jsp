			...
			<table class="table text-center">
				...
				<c:forEach var="vo" items="${vos}">
					<tr class=" table table-bordered" >
						...
						<td>
							<input type="button" class="btn btn-warning" value="수정" onclick="location.href='adminServeyUpdate?idx=${vo.idx}';"/>
							<input type="button" class="btn btn-success" value="통계보기"  onclick="location.href='adminServeyResult?idx=${vo.idx}';"/>
						</td>
					</tr>
