...
<body>
	<div class="container-fluid">
	  ...
	  <ul class="nav headernav justify-content-end m-2 shadow">
    <li class="nav-item">
    ...
    <li class="nav-item">
	    <a class="nav-link btn btn-sm btn-outline-primary" href="${ctp}/member/memberLogout">
		  	<font class="headericon" size="4em"></font>
	    	  로그아웃
	    </a>
    </li>
	...
	<p><br/></p>
		<nav class="navbar navbar-expand-sm border shadow-sm">
		  <ul class="navbar-nav">
		...
		<div class="container-fluid p-5 border shadow-sm">
