...
<div class="row p-0 m-0 border shadow" style="background-color:#fff;border:1px solid gray">
	<div class="col"><h2 class="pl-3" style="font-family:'ChosunNm', sans-serif;"><b>상품 등록</b></h2></div>
	<div class="col">
		...
		<form name="myform" method="post" enctype="multipart/form-data" >
			<table class="table">
				...
				<tr>
					...
					<td>
						<b>옵션1 | </b> 옵션이름 : <input class="form-control" style="display:inline;width:30%" type="text" name="optionName" id="optionName1"> , 
						옵션가격 : <input class="form-control" style="display:inline;width:30%" type="text" name="optionPrice" id="optionPrice1"> 
